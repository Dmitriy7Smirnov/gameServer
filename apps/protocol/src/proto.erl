...
parse(float, <<Value:4/little-float-unit:8, Rest/binary>>) -> {Value, Rest};
parse(double, <<Value:8/little-float-unit:8, Rest/binary>>) -> {Value, Rest}.
...
pack(float, Float) -> <<Float:4/little-float-unit:8>>;
pack(double, Float) -> <<Float:8/little-float-unit:8>>.
